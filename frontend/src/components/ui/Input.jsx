...
export default function Input({ className = '', label, hint, error, ...props }) {
  return (
    <label className="block space-y-2">
      ...
      <input
        className={cn(
          'w-full rounded-2xl border border-white/10 bg-slate-950/60 px-4 py-3 text-slate-100 placeholder:text-slate-500 outline-none transition focus:border-teal-300/60 focus:ring-4 focus:ring-teal-400/10',
